...
function base64encode_core(f::Function, e::E, args...; context=nothing, padding=true) where {E<:Function}
...
"""
function base64encode(f::Function, args...; context=nothing, padding=true)
...
"""
function base64urlencode(f::Function, args...; context=nothing, padding=true)
